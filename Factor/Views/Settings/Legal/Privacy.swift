        ...
        NavigationView {
            ScrollView {
                VStack(alignment: .leading) {
                    ...
                    Text("This Privacy Policy decribes how your personal information is handled in Factor.")
                    ...
                    Text("We do not collect, use, save, or have access to any of your personal data stored in Factor.")
                        .padding(.bottom)
                    Text("Individual settings and any data generated by Factor are not personal and are stored only on your device. You may be asked to provide access to your photo library, but this is only so that you may open your photos in Factor and save them in your stored notes. We do not process that information at all and have no access to it.")
                        .padding(.bottom)
                    Text("In addition, if you take a photo using Factor, location data is saved in the image, but we have no access to that data and it is not shared with anyone unless you yourself choose to share the image.")
